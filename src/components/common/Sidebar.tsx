  ...
  return (
    <aside className="flex flex-col items-center h-screen w-[72px] py-5 bg-[#13151a] border-r border-white/[0.06]">
      ...
      <div className="flex flex-col items-center gap-3 px-[13px]">
        ...
        <Link href="/about" className="flex items-center justify-center w-[34px] h-[34px] rounded-full bg-gradient-to-br from-blue-500/40 to-sky-300/60 text-[13px]  text-gray-300 cursor-pointer select-none tracking-wide">
        <div className="w-9 h-9 rounded-full flex items-center justify-center text-[13px]  text-gray-300 cursor-pointer select-none tracking-wide">
          SX
        </div>
        </Link>
